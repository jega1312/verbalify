  ...
  return (
    <div className="flex items-center justify-between w-full gap-2 md:justify-around lg:justify-end">
      <button
        ...
        className="flex items-center justify-center text-white transition duration-300 ease-in-out bg-green-500 rounded-full hover:bg-green-500/85 hover:text-slate-950 size-10 md:size-12 hover:cursor-pointer"
      >
