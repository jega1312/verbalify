  ...
  return (
    <nav className="fixed w-full top-0 flex justify-between flex-wrap items-center py-6 px-8 lg:px-10  z-50 border-b transition duration-300 ease-in-out bg-white border-gray-200">
      ...
      <motion.div
        ...
        className="hidden lg:block py-2 px-4 dm-medium bg-green-500 text-white rounded-sm transition duration-300 ease-in-out relative hover:bg-green-500/85 hover:text-black hover:shadow-md hover:cursor-pointer"
      >
        <NavLink to="/contact">Get Started</NavLink>
      </motion.div>
    </nav>
